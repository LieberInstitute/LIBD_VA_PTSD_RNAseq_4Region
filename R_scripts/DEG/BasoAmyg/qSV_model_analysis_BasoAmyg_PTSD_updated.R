...
pdf('../pdf/basoamyg_voom_qsva.pdf', useDingbats = FALSE)
...
## no qSVA
pdf('../pdf/basoamyg_voom_noqsva.pdf', useDingbats = FALSE)
...
## no adjustment vars
pdf('../pdf/basoamyg_voom_noadj.pdf', useDingbats = FALSE)
...
#calculate library-size adjustment
dge = calcNormFactors(dge)
pdf('../pdf/basoamyg_voom_onlyPTSD_qsva.pdf', useDingbats = FALSE)
vGene = voom(dge,modQsva, plot=TRUE)
dev.off()
fitGene = lmFit(vGene)
eBGene = eBayes(fitGene)
...
## no qSVA
pdf('../pdf/basoamyg_voom_onlyPTSD_noqsva.pdf', useDingbats = FALSE)
vGene0 = voom(dge,mod, plot=TRUE)
dev.off()
fitGene0 = lmFit(vGene0)
eBGene0 = eBayes(fitGene0)
...
# no adjustment vars
pdf('../pdf/basoamyg_voom_onlyPTSD_noadj.pdf', useDingbats = FALSE)
...
save(geneStats_BasoAmyg, file = "../rdas/BasoAmyg/geneStats_DE_qSVA_BasoAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_BasoAmyg, file = gzfile("../csvs/BasoAmyg/geneStats_DE_qSVA_BasoAmyg_threeGroup.csv.gz"))
...
geneStats_BasoAmyg = geneStats
save(geneStats_BasoAmyg, file = "../rdas/BasoAmyg/geneStats_DE_noqSVA_BasoAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_BasoAmyg, file = gzfile("../csvs/BasoAmyg/geneStats_DE_noqSVA_BasoAmyg_threeGroup.csv.gz"))
...
geneStats_BasoAmyg = geneStats
save(geneStats_BasoAmyg, file = "../rdas/BasoAmyg/geneStats_DE_NoAdj_BasoAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_BasoAmyg, file = gzfile("../csvs/BasoAmyg/geneStats_DE_NoAdj_BasoAmyg_threeGroup.csv.gz"))


#####################################
#Explore Case-Control BasoAmyg (https://github.com/LieberInstitute/qsva_brain/blob/master/brainseq_phase2_qsv/explore_case_control.R)
#####################################
...
#> Sys.time()
#[1] "2019-01-30 10:32:44 EST"
#> proc.time()
#    user   system  elapsed 
# 632.077    5.124 1213.218 
#> options(width = 120)
#> session_info()
#─ Session info ───────────────────────────────────────────────────────────────────────────────────────────────────────
# setting  value                                                 
