...
#See also '.../R_scripts/qSV_model_analysis_MedialAmyg_PTSD_updated.R completed first
#####################################
...
save(geneStats_MedialAmyg, file = "rdas/MedialAmyg/geneStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_MedialAmyg, file = gzfile("csvs/MedialAmyg/geneStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
...
save(geneStats_MedialAmygall, file = "rdas/MedialAmyg/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_MedialAmygall, file = gzfile("csvs/MedialAmyg/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
...
## write out qSVA-based stats
exonStats_MedialAmyg = exonStats
save(exonStats_MedialAmyg, file = "rdas/MedialAmyg/exonStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(exonStats_MedialAmyg, file = gzfile("csvs/MedialAmyg/exonStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
...
save(exonStats_MedialAmygall, file = "rdas/MedialAmyg/exonStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(exonStats_MedialAmygall, file = gzfile("csvs/MedialAmyg/exonStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
...
## write out qSVA-based stats
jxnStats_MedialAmyg = jxnStats
save(jxnStats_MedialAmyg, file = "rdas/MedialAmyg/jxStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(jxnStats_MedialAmyg, file = gzfile("csvs/MedialAmyg/jxStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
...
save(jxnStats_MedialAmygall, file = "rdas/MedialAmyg/jxStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(jxnStats_MedialAmygall, file = gzfile("csvs/MedialAmyg/jxStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
...
## write out qSVA-based stats
txStats_MedialAmyg = txStats
save(txStats_MedialAmyg, file = "rdas/MedialAmyg/txStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(txStats_MedialAmyg, file = gzfile("csvs/MedialAmyg/txStats_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
...
save(txStats_MedialAmygall, file = "rdas/MedialAmyg/txStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(txStats_MedialAmygall, file = gzfile("csvs/MedialAmyg/txStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_threeGroup.csv.gz"))
