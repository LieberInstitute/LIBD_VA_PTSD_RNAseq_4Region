...
save(geneStats_DLPFCall, file = "rdas/DLPFC/geneStats_allcols_DE_qSVA_filterByExpr_DLPFC_threeGroup.rda")
...
save(exonStats_DLPFCall, file = "rdas/DLPFC/exonStats_allcols_DE_qSVA_filterByExpr_DLPFC_threeGroup.rda")
...
save(jxnStats_DLPFCall, file = "rdas/DLPFC/jxStats_allcols_DE_qSVA_filterByExpr_DLPFC_threeGroup.rda")
...
save(txStats_DLPFCall, file = "rdas/DLPFC/txStats_allcols_DE_qSVA_filterByExpr_DLPFC_threeGroup.rda")
