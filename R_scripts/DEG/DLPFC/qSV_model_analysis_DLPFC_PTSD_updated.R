...
pdf('../pdf/dlpfc_voom_onlyPTSD_qsva.pdf', useDingbats = FALSE)
vGene = voom(dge,modQsva, plot=TRUE)
dev.off()
...
## no qSVA
pdf('../pdf/dlpfc_voom_onlyPTSD_noqsva.pdf', useDingbats = FALSE)
vGene0 = voom(dge,mod, plot=TRUE)
dev.off()
...
## no adjustment vars
pdf('../pdf/dlpfc_voom_onlyPTSD_noadj.pdf', useDingbats = FALSE)
...
geneStats_DLPFC = geneStats
save(geneStats_DLPFC, file = "../rdas/geneStats_DE_noqSVA_DLPFC_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_DLPFC, file = gzfile("../csvs/geneStats_DE_noqSVA_DLPFC_threeGroup.csv.gz"))
...
geneStats_DLPFC = geneStats
save(geneStats_DLPFC, file = "../rdas/geneStats_DE_NoAdj_DLPFC_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_DLPFC, file = gzfile("../csvs/geneStats_DE_NoAdj_DLPFC_threeGroup.csv.gz"))
...
#> Sys.time()
#[1] "2019-01-30 10:08:11 EST"
#> proc.time()
#    user   system  elapsed 
# 889.605    6.324 1899.594 
#> options(width = 120)
#> session_info()
#─ Session info ───────────────────────────────────────────────────────────────────────────────────────────────────────
# setting  value                                                 
...
─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────
 ...
 R.utils                2.7.0     2018-08-27 [2] CRAN (R 3.5.1)                                 
 ...
 recount.bwtool       * 0.99.29   2019-01-16 [1] Github (LieberInstitute/recount.bwtool@e6df598)
