...
#####################################
#Case-Control dACC (https://github.com/LieberInstitute/qsva_brain/blob/master/brainseq_phase2_qsv/casectrl_DLPFC.R)
#####################################
...
pdf('../pdf/dACC_voom_qsva.pdf', useDingbats = FALSE)
...
## no qSVA
pdf('../pdf/dACC_voom_noqsva.pdf', useDingbats = FALSE)
...
## no adjustment vars
pdf('../pdf/dACC_voom_noadj.pdf', useDingbats = FALSE)
...
pdf('../pdf/dACC_voom_onlyPTSD_qsva.pdf', useDingbats = FALSE)
vGene = voom(dge,modQsva, plot=TRUE)
dev.off()
...
## no qSVA
pdf('../pdf/dACC_voom_onlyPTSD_noqsva.pdf', useDingbats = FALSE)
vGene0 = voom(dge,mod, plot=TRUE)
dev.off()
...
## no adjustment vars
pdf('../pdf/dACC_voom_onlyPTSD_noadj.pdf', useDingbats = FALSE)
...
save(geneStats_dACC, file = "../rdas/geneStats_DE_qSVA_dACC_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_dACC, file = gzfile("../csvs/geneStats_DE_qSVA_dACC_threeGroup.csv.gz"))
...
geneStats_dACC = geneStats
save(geneStats_dACC, file = "../rdas/geneStats_DE_noqSVA_dACC_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_dACC, file = gzfile("../csvs/geneStats_DE_noqSVA_dACC_threeGroup.csv.gz"))
...
geneStats_dACC = geneStats
save(geneStats_dACC, file = "../rdas/geneStats_DE_NoAdj_dACC_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_dACC, file = gzfile("../csvs/geneStats_DE_NoAdj_dACC_threeGroup.csv.gz"))




#####################################
#Explore Case-Control dACC (https://github.com/LieberInstitute/qsva_brain/blob/master/brainseq_phase2_qsv/explore_case_control.R)
#####################################
...
#> Sys.time()
#[1] "2019-01-30 11:10:53 EST"
#> proc.time()
#   user  system elapsed 
#633.898   4.888 938.025 
#> options(width = 120)
#> session_info()
#─ Session info ───────────────────────────────────────────────────────────────────────────────────────────────────────
# setting  value                                                 
