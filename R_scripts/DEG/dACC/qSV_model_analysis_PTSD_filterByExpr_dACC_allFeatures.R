...
save(geneStats_dACCall, file = "rdas/dACC/geneStats_allcols_DE_qSVA_filterByExpr_dACC_threeGroup.rda")
...
save(exonStats_dACCall, file = "rdas/dACC/exonStats_allcols_DE_qSVA_filterByExpr_dACC_threeGroup.rda")
...
save(jxnStats_dACCall, file = "rdas/dACC/jxStats_allcols_DE_qSVA_filterByExpr_dACC_threeGroup.rda")
...
save(txStats_dACCall, file = "rdas/dACC/txStats_allcols_DE_qSVA_filterByExpr_dACC_threeGroup.rda")
