...
save(geneStats_MedialAmyg, file = "rdas/geneStats_DE_qSVA_sensitivity_antidepressants_MedialAmyg_threeGroup.rda")
write.csv(geneStats_MedialAmyg, file = gzfile("csvs/geneStats_DE_qSVA_sensitivity_antidepressants_MedialAmyg_threeGroup.csv.gz"))
