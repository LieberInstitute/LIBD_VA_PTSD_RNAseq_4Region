...
geneStats_dACCall_opioidstox = geneStatsall
save(geneStats_dACCall_opioidstox, file = "rdas/dACC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_dACC_opioidstox.rda")

write.csv(geneStats_dACCall_opioidstox, file = gzfile("csvs/dACC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_dACC_opioidstox.csv.gz"))
