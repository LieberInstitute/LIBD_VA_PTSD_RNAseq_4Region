...
save(geneStats_dACC, file = "rdas/geneStats_DE_qSVA_sensitivity_opioids_dACC_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_dACC, file = gzfile("csvs/geneStats_DE_qSVA_sensitivity_opioids_dACC_threeGroup.csv.gz"))
