...
geneStats_DLPFCall_opioidstox = geneStatsall
save(geneStats_DLPFCall_opioidstox, file = "rdas/DLPFC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_DLPFC_opioidstox.rda")

write.csv(geneStats_DLPFCall_opioidstox, file = gzfile("csvs/DLPFC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_DLPFC_opioidstox.csv.gz"))
