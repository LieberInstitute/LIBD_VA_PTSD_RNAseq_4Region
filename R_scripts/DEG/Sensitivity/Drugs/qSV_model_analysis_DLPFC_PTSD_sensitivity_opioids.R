...
save(geneStats_DLPFC, file = "rdas/geneStats_DE_qSVA_sensitivity_opioids_DLPFC_threeGroup.rda")
#dir.create("csvs",showWarnings = FALSE)
write.csv(geneStats_DLPFC, file = gzfile("csvs/geneStats_DE_qSVA_sensitivity_opioids_DLPFC_threeGroup.csv.gz"))
