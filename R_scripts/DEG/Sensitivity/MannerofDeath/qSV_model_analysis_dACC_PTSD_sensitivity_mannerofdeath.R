...
save(geneStats_dACC, file = "rdas/geneStats_DE_qSVA_sensitivity_mannerofdeath_dACC_threeGroup.rda")
write.csv(geneStats_dACC, file = gzfile("csvs/geneStats_DE_qSVA_sensitivity_mannerofdeath_dACC_threeGroup.csv.gz"))
