...
load('rdas/PTSD_qsvs_sensitivity_mannerofdeath.Rdata')
...
load('rdas/PTSD_onlyPTSD_qsvs_sensitivity_mannerofdeath.Rdata')
...
save(geneStats_MedialAmyg, file = "rdas/geneStats_DE_qSVA_sensitivity_mannerofdeath_MedialAmyg_threeGroup.rda")
write.csv(geneStats_MedialAmyg, file = gzfile("csvs/geneStats_DE_qSVA_sensitivity_mannerofdeath_MedialAmyg_threeGroup.csv.gz"))
