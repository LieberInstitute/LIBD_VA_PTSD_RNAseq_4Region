...
save(geneStats_DLPFC, file = "rdas/geneStats_DE_qSVA_sensitivity_mannerofdeath_DLPFC_threeGroup.rda")
write.csv(geneStats_DLPFC, file = gzfile("csvs/geneStats_DE_qSVA_sensitivity_mannerofdeath_DLPFC_threeGroup.csv.gz"))
