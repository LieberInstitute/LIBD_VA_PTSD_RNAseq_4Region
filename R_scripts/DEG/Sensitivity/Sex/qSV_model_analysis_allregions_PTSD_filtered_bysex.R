...
geneStatsall = cbind(geneStatsall, rowData(rse_gene))
## write out qSVA-based stats
geneStats_MedialAmygall_male = geneStatsall
save(geneStats_MedialAmygall_male, file = "rdas/MedialAmyg/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_males_threeGroup.rda")

write.csv(geneStats_MedialAmygall_male, file = gzfile("csvs/MedialAmyg/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_males_threeGroup.csv.gz"))
...
geneStatsall = cbind(geneStatsall, rowData(rse_gene))
## write out qSVA-based stats
geneStats_dACCall_male = geneStatsall
save(geneStats_dACCall_male, file = "rdas/dACC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_dACC_males_threeGroup.rda")

write.csv(geneStats_dACCall_male, file = gzfile("csvs/dACC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_dACC_males_threeGroup.csv.gz"))
...
geneStatsall = cbind(geneStatsall, rowData(rse_gene))
## write out qSVA-based stats
geneStats_DLPFCall_male = geneStatsall
save(geneStats_DLPFCall_male, file = "rdas/DLPFC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_DLPFC_males_threeGroup.rda")

write.csv(geneStats_DLPFCall_male, file = gzfile("csvs/DLPFC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_DLPFC_males_threeGroup.csv.gz"))
...
geneStatsall = cbind(geneStatsall, rowData(rse_gene))
## write out qSVA-based stats
geneStats_MedialAmygall_female = geneStatsall
save(geneStats_MedialAmygall_female, file = "rdas/MedialAmyg/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_females_threeGroup.rda")

write.csv(geneStats_MedialAmygall_female, file = gzfile("csvs/MedialAmyg/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_MedialAmyg_females_threeGroup.csv.gz"))
...
geneStatsall = cbind(geneStatsall, rowData(rse_gene))
## write out qSVA-based stats
geneStats_dACCall_female = geneStatsall
save(geneStats_dACCall_female, file = "rdas/dACC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_dACC_females_threeGroup.rda")

write.csv(geneStats_dACCall_female, file = gzfile("csvs/dACC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_dACC_females_threeGroup.csv.gz"))
...
geneStatsall = cbind(geneStatsall, rowData(rse_gene))
## write out qSVA-based stats
geneStats_DLPFCall_female = geneStatsall
save(geneStats_DLPFCall_female, file = "rdas/DLPFC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_DLPFC_females_threeGroup.rda")

write.csv(geneStats_DLPFCall_female, file = gzfile("csvs/DLPFC/geneStats_allcols_DE_qSVA_lowlyexpressedfilter_DLPFC_females_threeGroup.csv.gz"))
