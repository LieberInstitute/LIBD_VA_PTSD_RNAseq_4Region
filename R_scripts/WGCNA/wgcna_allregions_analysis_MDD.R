...
#load objects
load("rdas/WGCNA/constructed_network_signed_bicor_allregions_MDD.rda",verbose=TRUE)
...
colnames(modQsva)
dim(modQsva)
modQsva = modQsva[,c(1,2,4:8,21,23,25,3,9:20,22,24,26:46)]
head(modQsva)
...
save(coefAdj, file="rdas/WGCNA/MEvsDx_allregions_MDD.rda")
...
save(go_modules_allregions, file="rdas/WGCNA/wgcna_allregions_GO_clusterProfiler_MDD.rda")
