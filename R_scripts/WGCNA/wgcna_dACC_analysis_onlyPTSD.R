...
#load network
load("rdas/WGCNA/constructed_network_signed_bicor_dACC_onlyPTSD.rda", verbose = TRUE)
#load rse objects
...
save(coefAdj, file="rdas/WGCNA/MEvsDx_dACC_onlyPTSD.rda")
...
#save(GOenr, file="rdas/dACC/wgcna_dACC_GO_onlyPTSD.rda")
...
save(go_modules_dacc, file="rdas/dACC/wgcna_dACC_GO_clusterProfiler_onlyPTSD.rda")
