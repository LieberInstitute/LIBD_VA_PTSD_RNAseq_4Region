...
#load network
load("rdas/WGCNA/constructed_network_signed_bicor_DLPFC_PTSD.rda", verbose = TRUE)
#load rse objects
...
save(coefAdj, file="rdas/WGCNA/MEvsDx_DLPFC_PTSD.rda")
...
save(go_modules_DLPFC, file="rdas/DLPFC/wgcna_DLPFC_GO_clusterProfiler_PTSD.rda")
