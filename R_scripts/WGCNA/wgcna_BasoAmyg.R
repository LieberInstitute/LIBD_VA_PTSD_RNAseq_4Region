...
save(sftthresh1, file = "Data/rdas/WGCNA/BasoAmyg/power_object_BasoAmyg.rda")
...
net = blockwiseModules(t(geneExprsClean), power = sftthresh1$powerEstimate,
                            ...
                            saveTOMFileBase = "Data/rdas/WGCNA/BasoAmyg/wgcna_signed_TOM_BasoAmyg")
fNames = rownames(geneExprs)
save(net, fNames, file = "Data/rdas/WGCNA/BasoAmyg/constructed_network_signed_bicor_BasoAmyg.rda")
...
save(coefAdj_MDD,coefAdj_PTSD,coefAdj_onlyPTSD, file="Data/rdas/WGCNA/BasoAmyg/MEvsDx_BasoAmyg.rda")
...
names(moduleGeneList_adj) = paste0("BasoAmyg_", names(moduleGeneList_adj))
...
save(go_modules, file="Data/rdas/WGCNA/BasoAmyg/wgcna_BasoAmyg_GO_clusterProfiler.rda")
