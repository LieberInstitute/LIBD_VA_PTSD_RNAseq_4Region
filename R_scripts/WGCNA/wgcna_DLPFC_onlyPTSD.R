...
save(sftthresh1, file = "rdas/WGCNA/power_object_DLPFC_onlyPTSD.rda")
...
net = blockwiseModules(t(geneExprsClean), power = sftthresh1$powerEstimate,
                            ...
                            saveTOMFileBase = "rdas/WGCNA/wgcna_signed_TOM_DLPFC_onlyPTSD")
fNames = rownames(geneExprs)
save(net, fNames, file = "rdas/WGCNA/constructed_network_signed_bicor_DLPFC_onlyPTSD.rda")
