...
save(sftthresh1, file = "Data/rdas/WGCNA/MedialAmyg/power_object_MedialAmyg.rda")
...
net = blockwiseModules(t(geneExprsClean), power = sftthresh1$powerEstimate,
                            ...
                            saveTOMFileBase = "Data/rdas/WGCNA/MedialAmyg/wgcna_signed_TOM_MedialAmyg")
fNames = rownames(geneExprs)
save(net, fNames, file = "Data/rdas/WGCNA/MedialAmyg/constructed_network_signed_bicor_MedialAmyg.rda")
...
save(coefAdj_MDD,coefAdj_PTSD,coefAdj_onlyPTSD, file="Data/rdas/WGCNA/MedialAmyg/MEvsDx_MedialAmyg.rda")
...
names(moduleGeneList_adj) = paste0("MedialAmyg_", names(moduleGeneList_adj))
...
save(go_modules, file="Data/rdas/WGCNA/MedialAmyg/wgcna_MedialAmyg_GO_clusterProfiler.rda")
