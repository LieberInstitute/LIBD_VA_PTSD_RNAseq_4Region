...
#load network
load("rdas/WGCNA/constructed_network_signed_bicor_MedialAmyg_MDD.rda", verbose = TRUE)
#load rse objects
...
save(coefAdj, file="rdas/WGCNA/MEvsDx_MedialAmyg_MDD.rda")
...
save(go_modules_MedialAmyg, file="rdas/MedialAmyg/wgcna_MedialAmyg_GO_clusterProfiler_MDD.rda")
