...
save(sftthresh1, file = "rdas/WGCNA/power_object_allregions_MDD.rda")
...
net = blockwiseModules(t(geneExprsClean), power = sftthresh1$powerEstimate,
                            ...
                            saveTOMFileBase = "rdas/WGCNA/wgcna_signed_TOM_allregions_MDD")
fNames = rownames(geneExprs)
save(net, fNames, file = "rdas/WGCNA/constructed_network_signed_bicor_allregions_MDD.rda")
