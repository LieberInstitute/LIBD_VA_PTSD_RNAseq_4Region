...
#load network
load("rdas/WGCNA/constructed_network_signed_bicor_dACC_MDD.rda", verbose = TRUE)
#load rse objects
...
save(coefAdj, file="rdas/WGCNA/MEvsDx_dACC_MDD.rda")
...
save(go_modules_dACC, file="rdas/dACC/wgcna_dACC_GO_clusterProfiler_MDD.rda")
